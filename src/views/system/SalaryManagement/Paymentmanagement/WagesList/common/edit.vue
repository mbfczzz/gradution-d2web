...
export default {
    ...
    methods:{
      reset:function () {
              ...
              this.form.empMoney=this.tmp.empMoney
              this.form.moneyDescribe=this.tmp.moneyDescribe
              this.form.refundWay=this.tmp.refundWay
              this.form.moneyItem=this.tmp.moneyItem
      },
      reload:function () {
        this.$emit("reload")
      },
      onSubmit:async function () {
        const res = await api.UPDATE_MONEY({
              id:this.form.id,
